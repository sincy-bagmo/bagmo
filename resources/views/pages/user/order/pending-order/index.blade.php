        ...
        <div class="card">
            <div class="card-header">
                <div class="card-title">
                    <p>Pending Orders - (Requested Orders)</p>
                </div>
                <div id="buttons">
                    ...
                    <form id="form-filter" class="dt_adv_search" method="GET">
                        <div class="row g-1 mb-md-1">
                            <div class="col-md-3">
                                ...
                                <input type="text" value="{{ Request::get('barcode') != null ? Request::get('barcode') : '' }}" name="barcode" id="barcode" class="form-control dt-input dt-first_name" data-column="1" placeholder="Barcode" data-column-index="0" />
                            </div>
                            <div class="col-md-3">
                    ...
                    <table id="dataTable1" class="invoice-list-table table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center"> <a href="{{route('user.order.pending-order.edit', $item->id)}}" class="btn btn-primary btn-sm" title="Edit"><i class="fas fa-edit"></i></a></td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
