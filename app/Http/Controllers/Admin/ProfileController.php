...
use App\Http\Requests\Admin\Profile\ProfileImageUpdateRequest;
...
class ProfileController extends BaseController
{
    ...
    {
        $user = Auth::guard(AuthConstants::GUARD_ADMIN)->user();
        $data = [
    ...
    {
        $userLoginLogs =  AdminLoginLog::orderBy('id', 'desc')->get();
